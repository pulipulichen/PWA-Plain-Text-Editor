(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["vendors~vendors/FloatActionButton"],{

/***/ "./node_modules/responsiveVoice/responsivevoice.js":
/*!*********************************************************!*\
  !*** ./node_modules/responsiveVoice/responsivevoice.js ***!
  \*********************************************************/
	...
	this.speak = function(text, voicename, parameters) {
		...
		for (var i=0; i<multipartText.length; i++) {
			...
			if (!fallbackMode) {
				...
				var url = 'http://www.corsproxy.com/translate.google.com/translate_tts?ie=UTF-8&q=' + multipartText[i] + '&tl=' + profile.collectionvoice.lang || false || false;
